pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~simple.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~simple.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_simple");
...
--  BEGIN Object file/option list
   --   ./simple.o
   --   -L./
   --   -L/usr/lib/gcc/x86_64-pc-linux-gnu/7.3.0/adalib/
   --   -static
   --   -lgnarl
   --   -lgnat
   --   -lpthread
